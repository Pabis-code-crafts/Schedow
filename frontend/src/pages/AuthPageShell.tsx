...
export function AuthPageShell({
  ...
  subtitle,
  title,
}: PropsWithChildren<{ sideContent?: ReactNode; title: string; subtitle: string }>) {
  return (
    <Box sx={{ alignItems: 'center', bgcolor: 'background.default', display: 'flex', minHeight: '100vh', px: 2, py: 4 }}>
      <Stack alignItems="center" spacing={3} sx={{ mx: 'auto', width: '100%', maxWidth: sideContent ? 920 : 440 }}>
